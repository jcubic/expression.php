						...
						do {
							...
							do {
								...
								do {
									...
									while(\false);
									if($_336 === \true) { $_338 = \true; break; }
									$result = $res_331;
									$this->setPos($pos_331);
									$_338 = \false; break;
								}
								while(\false);
								if($_338 === \true) { $_340 = \true; break; }
								$result = $res_329;
								$this->setPos($pos_329);
								$_340 = \false; break;
							}
							while(\false);
							if($_340 === \true) { $_342 = \true; break; }
							$result = $res_327;
							$this->setPos($pos_327);
							$_342 = \false; break;
						}
						while(\false);
						if($_342 === \true) { $_344 = \true; break; }
						$result = $res_325;
						$this->setPos($pos_325);
						$_344 = \false; break;
					}
					while(\false);
					if($_344 === \true) { $_346 = \true; break; }
					$result = $res_323;
					$this->setPos($pos_323);
					$_346 = \false; break;
				}
...
function match_Start($stack = []) {
	...
	do {
		...
		while(\false);
		if($_385 === \false) { $_388 = \false; break; }
		$res_387 = $result;
		$pos_387 = $this->pos;
		if (\substr($this->string, $this->pos, 1) === ';') {
			$this->addPos(1);
